...
# Исправление конфликта с QGIS: если PYTHONHOME указывает на QGIS,
# убираем его чтобы не было SRE module mismatch
if "PYTHONHOME" in os.environ and "QGIS" in os.environ["PYTHONHOME"]:
    del os.environ["PYTHONHOME"]
if "PYTHONPATH" in os.environ and "QGIS" in os.environ.get("PYTHONPATH", ""):
